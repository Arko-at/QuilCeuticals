...
export default function Contact() {
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-stone-950 text-stone-900 dark:text-white pt-24">
      {/* Header Section */}
      <section className="w-full py-24 md:py-32 px-6 lg:px-12 bg-[#fcfcfc] dark:bg-[#050505] transition-colors duration-1000">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-8">
          ...
          >
            <span className="text-[10px] uppercase tracking-[0.5em] font-medium text-[#D4AF37]">Client Services</span>
            <h1 className="font-serif text-5xl md:text-8xl font-thin tracking-tight leading-tight uppercase">
              Clinical <span className="italic text-luxury-gradient">Concierge.</span>
            </h1>
          </motion.div>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            ...
            className="max-w-3xl text-stone-600 dark:text-white/80 text-lg md:text-xl font-light leading-relaxed font-serif italic"
          >
            “QuilCeuticals transcends traditional skincare. We are dedicated to providing our clientele with unparalleled service, ensuring that your journey to cellular optimization is as seamless and luxurious as the formulations themselves.”
          </motion.p>
          <motion.div
             initial={{ opacity: 0 }}
             animate={{ opacity: 1 }}
          ...
          >
            <p className="text-[#D4AF37] text-[10px] tracking-widest uppercase">Expert Guidance & Formulatory Support</p>
            <h3 className="text-xl md:text-2xl font-serif font-thin mt-8 text-stone-900 dark:text-white">How may we assist in your regimen?</h3>
          </motion.div>
        </div>
      </section>
